...
SERVICE = []
# custom print
def report_service(vulnerable, service, cost, url):
	SERVICE.append({
...
def scan_gmaps(apikey):
	...
	if response.text.find("errors") < 0:
		...
		report_service(True, "customsearch", "$5 per 1000 requests", url) 
	else:
		print("API key is not vulnerable for Custom Search API.")
		print("Reason: "+ str(response.json()["error"]["errors"][0]["message"]))
		report_service(False, "customsearch", "$5 per 1000 requests", url)
	...
	if response.status_code == 200:
		...
		report_service(True, "Staticmap", "$2 per 1000 requests", url) 
	else:
		print("API key is not vulnerable for Staticmap API.")
		print("Reason: "+ str(response.content))
		report_service(False, "Staticmap", "$2 per 1000 requests", url) 
	...
	if response.status_code == 200:
		...
		report_service(True, "Streetview", "$7 per 1000 requests", url) 
	else:
		print("API key is not vulnerable for Streetview API.")
		print("Reason: "+ str(response.content))
		report_service(False, "Streetview", "$7 per 1000 requests", url) 
	...
	if response.text.find("error_message") < 0:
		...
		report_service(True, "Directions", "$5 per 1000 requests", url) 
		report_service(True, "Directions (Advanced)", "$10 per 1000 requests", url) 
	else:
		print("API key is not vulnerable for Directions API.")
		print("Reason: "+ response.json()["error_message"])
		report_service(False, "Directions", "$5 per 1000 requests", url) 
		report_service(False, "Directions (Advanced)", "$10 per 1000 requests", url) 
	...
	if response.text.find("error_message") < 0:
		...
		report_service(True, "Geocode", "$5 per 1000 requests", url) 
	else:
		print("API key is not vulnerable for Geocode API.")
		print("Reason: "+ response.json()["error_message"])
		report_service(False, "Geocode", "$5 per 1000 requests", url) 
	...
	if response.text.find("error_message") < 0:
		...
		report_service(True, "Distance Matrix", "$5 per 1000 requests", url) 
		report_service(True, "Distance Matrix (Advanced)", "$10 per 1000 requests", url) 
	else:
		print("API key is not vulnerable for Distance Matrix API.")
		print("Reason: "+ response.json()["error_message"])
		report_service(False, "Distance Matrix", "$5 per 1000 requests", url) 
		report_service(False, "Distance Matrix (Advanced)", "$10 per 1000 requests", url) 
	...
	if response.text.find("error_message") < 0:
		...
		report_service(True, "Find Place From Text", "$17 per 1000 requests", url) 
	else:
		print("API key is not vulnerable for Find Place From Text API.")
		print("Reason: "+ response.json()["error_message"])
		report_service(False, "Find Place From Text", "$17 per 1000 requests", url) 
	...
	if response.text.find("error_message") < 0:
		...
		report_service(True, "Autocomplete", "$2.83 per 1000 requests", url) 
		report_service(True, "Autocomplete Per Session", "$17 per 1000 requests", url) 
	else:
		print("API key is not vulnerable for Autocomplete API.")
		print("Reason: "+ response.json()["error_message"])
		report_service(False, "Autocomplete", "$2.83 per 1000 requests", url) 
		report_service(False, "Autocomplete Per Session", "$17 per 1000 requests", url) 
	...
	if response.text.find("error_message") < 0:
		...
		report_service(True, "Elevation", "$5 per 1000 requests", url) 
	else:
		print("API key is not vulnerable for Elevation API.")
		print("Reason: "+ response.json()["error_message"])
		report_service(False, "Elevation", "$5 per 1000 requests", url) 
	...
	if response.text.find("errorMessage") < 0:
		...
		report_service(True, "Timezone", "$5 per 1000 requests", url) 
	else:
		print("API key is not vulnerable for Timezone API.")
		print("Reason: "+ response.json()["errorMessage"])
		report_service(False, "Timezone", "$5 per 1000 requests", url) 
	...
	if response.text.find("error") < 0:
		...
		report_service(True, "Nearest Roads", "$10 per 1000 requests", url) 
	else:
		print("API key is not vulnerable for Nearest Roads API.")
		print("Reason: "+ response.json()["error"]["message"])
		report_service(False, "Nearest Roads", "$10 per 1000 requests", url) 
	...
	if response.text.find("error") < 0:
		...
		report_service(True, "Geolocation", "$5 per 1000 requests", url) 
	else:
		print("API key is not vulnerable for Geolocation API.")
		print("Reason: "+ response.json()["error"]["message"])
		report_service(False, "Geolocation", "$5 per 1000 requests", url) 
	...
	if response.text.find("error") < 0:
		...
		report_service(True, "Route to Traveled", "$10 per 1000 requests", url) 
	else:
		print("API key is not vulnerable for Route to Traveled API.")
		print("Reason: "+ response.json()["error"]["message"])
		report_service(False, "Route to Traveled", "$10 per 1000 requests", url) 
	...
	if response.text.find("error") < 0:
		...
		report_service(True, "Speed Limit-Roads", "$20 per 1000 requests", url) 
	else:
		print("API key is not vulnerable for Speed Limit-Roads API.")
		print("Reason: "+ response.json()["error"]["message"])
		report_service(False, "Speed Limit-Roads", "$20 per 1000 requests", url) 
	...
	if response.text.find("error_message") < 0:
		...
		report_service(True, "Place Details", "17 per 1000 requests", url) 
	else:
		print("API key is not vulnerable for Place Details API.")
		print("Reason: "+ response.json()["error_message"])
		report_service(False, "Place Details", "17 per 1000 requests", url) 
	...
	if response.text.find("error_message") < 0:
		...
		report_service(True, "Nearby Search-Places", "$32 per 1000 requests", url) 
	else:
		print("API key is not vulnerable for Nearby Search-Places API.")
		print("Reason: "+ response.json()["error_message"])
		report_service(False, "Nearby Search-Places", "$32 per 1000 requests", url) 
	...
	if response.text.find("error_message") < 0:
		...
		report_service(True, "Text Search-Places", "$32 per 1000 requests", url) 
	else:
		print("API key is not vulnerable for Text Search-Places API.")
		print("Reason: "+ response.json()["error_message"])
		report_service(False, "Text Search-Places", "$32 per 1000 requests", url) 
	...
	if response.status_code == 302:
		...
		report_service(True, "Places Photo", "$7 per 1000 requests", url) 
	else:
		...
		report_service(False, "Places Photo", "$7 per 1000 requests", url) 
	...
	if response.status_code == 200:
		...
		report_service(True, "FCM Takeover", "???", url) 
	else:
		print("API key is not vulnerable for FCM API.")
		report_service(False, "FCM Takeover", "???", url) 
